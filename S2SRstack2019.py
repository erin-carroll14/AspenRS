...
stacked2019_MayOct = mosaic5.addBands(mosaic6).addBands(mosaic7).addBands(mosaic8).addBands(mosaic9).addBands(mosaic10)
stacked2019_JunOct = mosaic6.addBands(mosaic7).addBands(mosaic8).addBands(mosaic9).addBands(mosaic10)

print('stacked2019 loaded')