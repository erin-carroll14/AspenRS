# -*- coding: utf-8 -*-
"""ploidy_RF_ensemble_2019_2020

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Gp9Rr0DklcQvqqR-kHpY96JapX83r9Vw

Train on 2020, deploy on 2019
"""
...
# call 2019 imagery, 2020 imagery, 2019 aspen mask, RF model
# %cd /content/drive/My\ Drive/Colab\ Notebooks/Aspen/Cytotype

from S2SRstack2019 import stacked2019_JunOct, Colorado
from dist_rf_rmbl_2019 import aspenMask2019
from dist_rf_rmbl_2020 import stackVegRMBL2020
...
# train on 2020, deploy on 2019
result = RFmodelPloidy(training2, training3, stackVegRMBL2020, stackVegRMBLaspen2019)
print('success')
...
expT = ee.batch.Export.table.toDrive(collection=trainResult,
                                     description='trainResult_2019-2020',
                                     fileFormat='CSV')
expV = ee.batch.Export.table.toDrive(collection=valResult,
                                     description='valResult_2019-2020',
                                     fileFormat='CSV')
...
linkT = 'https://drive.google.com/file/d/1TldyK-Pim6KluatPJglKyMqHecFOw0av/view?usp=sharing'
linkV = 'https://drive.google.com/file/d/1ZWNnnpgvtEmG3xTlbaU2ON4J6RJ3nCHj/view?usp=sharing'
...
downloadedT.GetContentFile('trainResult_2020.csv')   
trainDF = pd.read_csv('trainResult_2020.csv') 

downloadedV = drive.CreateFile({'id':idV})  
downloadedV.GetContentFile('valResult_2019-2020.csv')   
valDF = pd.read_csv('valResult_2019-2020.csv') 
